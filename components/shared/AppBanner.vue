<template>
  <div :class="['relative w-full h-screen overflow-hidden', { '-mt-[86.6px] md:-mt-[112px]': true }]" :style="{ borderRadius: `${borderRadiusValue}px` }">
...
const handleScroll = () => {
  ...
  borderRadiusValue.value = Math.min(scrollFraction * 640, 640) // maksymalne zaokrąglenie na 160px
}
